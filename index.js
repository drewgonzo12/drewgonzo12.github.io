...
function clearAllFields() {
    ...
    var ele = document.getElementsById("ageRange");
    for(var i=0;i<ele.length;i++)
       ele[i].checked = false;
    var ele = document.getElementsById("childrenPresent");
    for(var i=0;i<ele.length;i++)
       ele[i].checked = false;
    document.getElementById("numberOfChildren").value = ' ';
    var ele = document.getElementsById("medicalAttention");
    for(var i=0;i<ele.length;i++)
       ele[i].checked = false;
    var ele = document.getElementsById("patientReturnPossability");
    for(var i=0;i<ele.length;i++)
        ele[i].checked = false;
    document.getElementById("streetSleptOnNightBefore").value = ' ';
    var ele = document.getElementsById("seekingEmployment");
    for(var i=0;i<ele.length;i++)
        ele[i].checked = false;
    var ele = document.getElementsById("jobTypesSeeking");
    for(var i=0;i<ele.length;i++)
        ele[i].checked = false;
